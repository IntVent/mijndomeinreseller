...
class Domain extends Model
{
    ...
    public function register(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld) {
            $result = $this->client->put('domain_register', $this->attributes);
    ...
    public function transfer(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld) {
            $result = $this->client->put('domain_transfer', $this->attributes);
    ...
    public function delete(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld) {
            $result = $this->client->put('domain_delete', [
                'domein' => $this->domein,
                'tld' => $this->tld,
            ]);
    ...
    public function authInfo(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld) {
            $result = $this->client->get('domain_auth_info', [
                'domein' => $this->domein,
                'tld' => $this->tld,
            ]);
    ...
    public function updateContacts(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld) {
            $result = $this->client->get('domain_modify_contacts', $this->attributes);
    ...
    public function trade(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld) {
            $result = $this->client->get('domain_trade', $this->attributes);
    ...
    public function updateNameservers(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld) {
            $result = $this->client->get('domain_modify_ns', $this->attributes);
    ...
    public function pushRequest(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld && $this->authkey) {
            $result = $this->client->get('domain_push_request', [
                'domein' => $this->domein,
                'tld' => $this->tld,
    ...
    public function renew(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld && $this->duur) {
            $result = $this->client->get('domain_renew', [
                'domein' => $this->domein,
                'tld' => $this->tld,
                'duur' => $this->duur,
            ]);
    ...
    public function restore(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld) {
            $result = $this->client->get('domain_restore', [
                'domein' => $this->domein,
                'tld' => $this->tld,
            ]);
    ...
    public function setAutoRenew(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld && $this->autorenew) {
            $result = $this->client->get('domain_set_autorenew', [
                'domein' => $this->domein,
                'tld' => $this->tld,
    ...
    public function setLock(array $attributes = [])
    {
        ...
        if ($this->domein && $this->tld && $this->set_lock) {
            $result = $this->client->get('domain_set_lock', [
                'domein' => $this->domein,
                'tld' => $this->tld,
